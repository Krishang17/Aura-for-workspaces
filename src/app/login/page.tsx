      ...
      <Card className="w-full max-w-md border-slate-800 bg-slate-900/80 backdrop-blur-sm">
        <CardHeader className="text-center">
          ...
          <CardDescription className="text-slate-400">
            Your Digital Chief of Staff. Sign in to get started.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-3">
          ...
          <p className="pt-4 text-center text-xs text-slate-500">
            By signing in, you agree to let Aura access your email, calendar,
            and messaging data to provide intelligent summaries.
          </p>
        </CardContent>
      </Card>
    </div>
