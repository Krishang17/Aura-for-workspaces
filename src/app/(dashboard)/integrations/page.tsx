  ...
  const integrations = [
    {
      ...
      connected: isGoogle,
      connectedVia: isGoogle ? "Signed in" : undefined,
      icon: (
    ...
    },
    {
      ...
      connectedVia: isMicrosoft ? "Signed in" : undefined,
      icon: (
    ...
    <div className="mx-auto max-w-4xl space-y-6">
          ...
          <Card key={integration.id}>
            <CardContent className="flex items-center gap-6 p-6">
              ...
              <div className="flex-1 min-w-0">
                ...
                {integration.connected && session?.user?.email && (
      ...
      <Card>
        ...
        <CardContent className="text-sm text-muted-foreground space-y-2">
          ...
          <p>
            <strong>Slack</strong> can be connected separately so your team
            messages are included in your daily briefing. Your company admin can
            pre-approve the Slack app for all employees.
          </p>
          <p>
            Your credentials are never stored — only encrypted OAuth tokens. You
            can revoke access at any time from this page or from the
